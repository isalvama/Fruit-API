...
import cat.itacademy.s04.s02.n01.fruit.application.service.RegisterFruitService;
...
class FruitRestControllerTest {
    ...
    private static final FruitResponseDTO FRUIT_RESPONSE = new FruitResponseDTO(1L, NAME_OF_FRUIT, WEIGHT_AMOUNT, PROVIDER_ID);
    ...
    @MockitoBean
    private RegisterFruitService createFruitUseCase;
    ...
    class CreateFruit {
        ...
        void createFruit_withKgMagnitude_returns201WithLocationAndBodyFruitWithId() throws Exception {
            RegisterFruitRequestDTO createFruitDTO = new RegisterFruitRequestDTO(NAME_OF_FRUIT, WEIGHT_AMOUNT, KG_MAGNITUDE, PROVIDER_ID);
            when(createFruitUseCase.registerFruit(NAME_OF_FRUIT, WEIGHT_AMOUNT, KG_MAGNITUDE, PROVIDER_ID)).thenReturn(FRUIT);
            ResultActions result = mockMvc.perform(post(API_URL_STRING)
            ...
            verify(createFruitUseCase).registerFruit(NAME_OF_FRUIT, WEIGHT_AMOUNT, KG_MAGNITUDE, PROVIDER_ID);
        }
        ...
        void createFruit_returns400ValidationErrorInInputDataBlankName() throws Exception {
            String jsonInput =
                    "{\"name\": \"     \", \"weightAmount\" : 0.5, \"magnitude\": \"POUNDS\", \"providerId\": \"1\"}";
        ...
        void createFruit_returns400ValidationErrorNameLengthIsLessThan2() throws Exception {
            String jsonInput =
                    "{\"name\": \"a\", \"weightAmount\" : 0.5, \"magnitude\": \"POUNDS\", \"providerId\": \"1\"}";
        ...
        void createFruit_returns400ValidationErrorInInputDataWeightAmountIsNegative() throws Exception {
            String jsonInput =
                    "{\"name\": \"Pear\", \"weightAmount\" : -0.5, \"magnitude\": \"KILOGRAMS\", \"providerId\": \"1\"}";
        ...
        void createFruit_returns400ValidationErrorInInputDataInvalidMagnitude() throws Exception {
            String jsonInput =
                    "{\"name\": \"orange\", \"weightAmount\" : 0.5, \"magnitude\": \"INVALID_MAGNITUDE\", \"providerId\": \"1\"" +
                            "}";
        ...
        void createFruit_whenProviderDoesNotExist_returns404() throws Exception {
            ...
            RegisterFruitRequestDTO createFruitDTO = new RegisterFruitRequestDTO(NAME_OF_FRUIT, WEIGHT_AMOUNT, KG_MAGNITUDE, providerId);
            String exceptionMessage = String.format("Provider with id %s does not exist", providerId);

            when(createFruitUseCase.registerFruit(NAME_OF_FRUIT, WEIGHT_AMOUNT, KG_MAGNITUDE, providerId)).thenThrow(new ProviderNotFoundException(exceptionMessage));
            ...
            verify(createFruitUseCase).registerFruit(NAME_OF_FRUIT, WEIGHT_AMOUNT, KG_MAGNITUDE, providerId);
        }
    }
